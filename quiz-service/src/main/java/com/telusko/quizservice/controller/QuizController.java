...
public class QuizController {
	...
	@PostMapping("/create")
	public ResponseEntity<String> ceateQuiz(@RequestBody QuizDto quizDto) {
		//log.info("An INFO Message" + quizService.createQuiz(quizDto.getCategoryName(), quizDto.getNumQuestion(), quizDto.getTitle()));
